...
Public Class TestGraph
    ...
    Public Sub ClearGraphics() Implements IGraphInterface.ClearGraphics
        ...
        ReDim New_DrawingPen(0) 'Common Pen To Line Method
    ...
    Private Sub New_DrawPie(eG As Graphics)
        ...
        Dim PiePen As New Pen(Color.Red, 0)
    ...
    Private Sub DrawLinearX_Grid(ByVal eG As Graphics, xWidth As Single, xMin As Single, yMin As Single, xMax As Single, yMax As Single)
        ...
        Dim Grid_pen As New Pen(GridLine_Color, 0)
        Dim n As Integer = 0
    ...
    Private Sub AboutToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AboutToolStripMenuItem.Click
        MessageBox.Show("Created By Ross Waters (RossWatersjr@gmail.com)" & vbCrLf & "Created In VB Using Visual Studio 2019 Version 16.10.2" & vbCrLf & ".NET Framework 4.7.2" & vbCrLf & "Last Revision Date 06/24,2021" & vbCrLf & "Revision 1.5.8", "About", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
    ...
    Private Sub BarGraph1ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BarGraph1ToolStripMenuItem.Click
        ...
        Dim GridLinePen As New Pen(GridLineColor, 0)
